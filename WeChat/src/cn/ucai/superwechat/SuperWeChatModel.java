...
public class SuperWeChatModel {
     ...
     * @return
     */
    public boolean saveWeCahtContactList(List<User> contactList) {
        UserDao dao = new UserDao(context);
        dao.saveWeChatContactList(contactList);
        return true;
    }
    ...
    public Map<String, User> getWeChatContactList() {
        UserDao dao = new UserDao(context);
        return dao.getWeChatContactList();
    }
