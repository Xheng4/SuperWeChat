...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        if(message.direct() == Direct.SEND){
            EaseUserUtils.setWeChatUserAvatar(context, EMClient.getInstance().getCurrentUser(), userAvatarView);
        }else{
            EaseUserUtils.setWeChatUserAvatar(context, message.getFrom(), userAvatarView);
            EaseUserUtils.setWeChatUserNick(message.getFrom(), usernickView);
        }
